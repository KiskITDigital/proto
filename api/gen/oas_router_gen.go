				...
				case 'd': // Prefix: "dmin/"
					...
					case 'a': // Prefix: "auth/"
						...
						case 'r': // Prefix: "refresh"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleV1AdminAuthRefreshPostRequest([0]string{}, elemIsEscaped, w, r)
								default:
						...
						case 's': // Prefix: "signin"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleV1AdminAuthSigninPostRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, "POST")
								}
						...
						case 'u': // Prefix: "user"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleV1AdminAuthUserGetRequest([0]string{}, elemIsEscaped, w, r)
								default:
					...
					case 'u': // Prefix: "users"
						...
						if len(elem) == 0 {
							switch r.Method {
							case "GET":
								s.handleV1AdminUsersGetRequest([0]string{}, elemIsEscaped, w, r)
							case "POST":
								s.handleV1AdminUsersPostRequest([0]string{}, elemIsEscaped, w, r)
							default:
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleV1AdminUsersUserIDGetRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, "GET")
				...
				case 'd': // Prefix: "dmin/"
					...
					case 'a': // Prefix: "auth/"
						...
						case 'r': // Prefix: "refresh"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = "V1AdminAuthRefreshPost"
									r.summary = "Get new access token"
									r.operationID = ""
									r.pathPattern = "/v1/admin/auth/refresh"
									r.args = args
									r.count = 0
									return r, true
								default:
						...
						case 's': // Prefix: "signin"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = "V1AdminAuthSigninPost"
									r.summary = "Signin"
									r.operationID = ""
									r.pathPattern = "/v1/admin/auth/signin"
									r.args = args
									r.count = 0
									return r, true
								default:
						...
						case 'u': // Prefix: "user"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = "V1AdminAuthUserGet"
									r.summary = "Get currently authenticated user"
									r.operationID = ""
									r.pathPattern = "/v1/admin/auth/user"
									r.args = args
									r.count = 0
									return r, true
								default:
					...
					case 'u': // Prefix: "users"
						...
						if len(elem) == 0 {
							switch method {
							case "GET":
								r.name = "V1AdminUsersGet"
								r.summary = "Get admin users"
								r.operationID = ""
								r.pathPattern = "/v1/admin/users"
								r.args = args
								r.count = 0
								return r, true
							case "POST":
								r.name = "V1AdminUsersPost"
								r.summary = "Create admin user"
								r.operationID = ""
								r.pathPattern = "/v1/admin/users"
								r.args = args
								r.count = 0
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = "V1AdminUsersUserIDGet"
									r.summary = "Get admin users by id"
									r.operationID = ""
									r.pathPattern = "/v1/admin/users/{userID}"
									r.args = args
									r.count = 1
									return r, true
								default:
